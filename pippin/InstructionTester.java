...
public class InstructionTester {
	...
	public void testNOP() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getProgramCounter());
	...
	public void testLOD() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getProgramCounter());
		// Test accumulator modified
		assertEquals("Accumulator changed", -2560 + 120, machine.getAccumulator());
	}
	...
	public void testLODN() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getProgramCounter());
		// Test accumulator modified
		assertEquals("Accumulator changed", -2560 + 400, machine.getAccumulator());
	}
	...
	public void testJMPI() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 260, machine.getProgramCounter());
	...
	public void testJUMP() {
		...
		// should have set the program counter to 40
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 40, machine.getProgramCounter());
		assertEquals("Accumulator was not changed", 200, machine.getAccumulator());
	}
	...
	public void testJMZIaccumNonZero() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getProgramCounter());
		assertEquals("Accumulator was not changed", 200, machine.getAccumulator());
	}
	...
	public void testADD() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getProgramCounter());
		assertEquals("Accumulator was changed", 200 - 2560 + 120, machine.getAccumulator());
	}
	...
	public void testADDN() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getProgramCounter());
		assertEquals("Accumulator was changed", 200 - 2560 + 400, machine.getAccumulator());
	}
	...
	@Test
	public void testCOPYtargetAfter() {
			MachineModel machine = new MachineModel();
			
			machine.setData(50, 100);
			machine.setData(51, 110);
			machine.setData(52, 3);
			machine.setData(100, 5);
			machine.setData(101, 10);
			machine.setData(102, 15);
			
			machine.copy(50);

			assertEquals(machine.getData(100), machine.getData(110));
			assertEquals(machine.getData(101), machine.getData(111));
			assertEquals(machine.getData(102), machine.getData(112));
	}

	@Test
	public void testCOPYtargetBefore() {
	MachineModel machine = new MachineModel();
	
	machine.setData(50, 100);
	machine.setData(51, 90);
	machine.setData(52, 3);
	machine.setData(100, 5);
	machine.setData(101, 10);
	machine.setData(102, 15);
	...
	assertEquals(machine.getData(100), machine.getData(90));
	assertEquals(machine.getData(101), machine.getData(91));
	assertEquals(machine.getData(102), machine.getData(92));
	}

	@Test
	public void testCPYN() {
		MachineModel machine = new MachineModel(false);
		
		machine.setData(20, 50);
		machine.setData(50, 100);
		machine.setData(51, 110);
		machine.setData(52, 3);
		machine.setData(100, 5);
		...
		machine.INSTRUCTIONS.get(0x1D).execute(machine.getData(20));
		
		System.out.println(machine.getData(110));
		System.out.println(machine.getData(111));
		System.out.println(machine.getData(112));
		assertEquals(machine.getData(100), machine.getData(110));
		assertEquals(machine.getData(101), machine.getData(111));
		assertEquals(machine.getData(102), machine.getData(112));
	}
